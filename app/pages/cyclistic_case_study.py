...
layout = (
    html.Div(
        ...
        [
                        ...
                        [
                            dbc.ListGroup(
                                [
                                    ...
                                    dbc.ListGroupItem(html.A("Capstone Project Description", href="assets/cyclistic/ProjectDescription.html", target="_blank")),
                                    html.Br(),
                                    #the final report .hmtl
                                    dbc.ListGroupItem(html.A("Final Report", href="assets/cyclistic/2022_viz.html", target="_blank")),
                                    html.Br(),
                                    #Powerpoint Presentation 
                                    dbc.ListGroupItem(dbc.CardLink("PowerPoint Presentation", href="https://github.com/AlexanderFastner/Cyclystic_Case_Study/blob/main/Cyclistic%20presentation.pptx")),
                                    html.Br(),
                                    #Repo Link
                                    dbc.ListGroupItem(dbc.CardLink("Project Github Repo (R code here)", href="https://github.com/AlexanderFastner/Cyclystic_Case_Study")),
            ...
            dbc.Card(
                [
                    dbc.CardHeader(html.H2("Figures from the analysis")),
                    dbc.CardBody(
                        [
                            html.Br(),
