...
about = html.Div([
    ...
    dbc.Card(
        dbc.CardBody([
            ...
            html.Img(src=dash.get_asset_url("uni_logos/TUM_Logo_PNG.png"), height="7%", width="7%", style={"margin-right": "20px"}),
            dbc.CardLink("Technical University of Munich", href="https://www.tum.de/en/"),
            html.Br(),
            html.Img(src=dash.get_asset_url("uni_logos/LMU_Logo_PNG.png"), height="7%", width="7%", style={"margin-right": "20px"}),
            dbc.CardLink("Ludwig-Maximilians-Universitaet", href="https://www.lmu.de/en/", className="text-success"),
            html.H3("Bioinformatics Bachelor (TUM/LMU): Search for evidence of recombination in Alternaria solani using genomic tools"),
            html.P(
                """
            ...
            html.H3("Bioinformatics Master (TUM/LMU + Helmholtz Institute): Bioinformatic Analysis of the role of MAFA in Stem Cell-Derived Human Pancreatic Islets"),
            html.P(
                """
    ...
    dbc.CardBody(
        [   
            dbc.Col(
                ...
                html.Br(),
                html.Img(src=dash.get_asset_url(linkedin), height="32px", width="32px", style={"margin-right": "20px"}),
                dbc.CardLink("Linkedin", href="https://www.linkedin.com/in/alexander-fastner/"),
                html.Br(),
                html.Img(src=dash.get_asset_url(github), height="32px", width="32px", style={"margin-right": "20px"}),
